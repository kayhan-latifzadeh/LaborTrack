...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Extract handcrafted features from blink data.')
...
def main():
    ...
    session_1_data = load_csv_files('output/segmented_data/blinks/session_1')
    session_2_data = load_csv_files('output/segmented_data/blinks/session_2')
    ...
    np.save('output/X_blinks.npy', X)
    np.save('output/y_blinks.npy', y)
    
    print('X: output/X_blinks.npy')
    print('y: output/y_blinks.npy')
