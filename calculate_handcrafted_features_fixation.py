...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Extract handcrafted features from fixation data.')
...
def main():
    ...
    np.save('output/X_fixations.npy', X)
    np.save('output/y_fixations.npy', y)
    
    print('X: output/X_fixations.npy')
    print('y: output/y_fixations.npy')
